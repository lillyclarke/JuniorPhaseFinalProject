...
const seed = async () => {
  try{
    ...
    let Students = await Promise.all([
      ...
      Student.create({id: 2, firstName: 'Bob', lastName: 'Cook', email: 'BobCook@gmail.com', gpa: 3.5, campusId: 3}),
      Student.create({id: 3, firstName: 'Mary', lastName: 'Loe', email: 'maryloe@gmail.com', gpa: 3.5, campusId: 2}),
      Student.create({id: 4, firstName: 'Jane', lastName: 'Poe', email: 'JanePoe@yahoo.com', gpa: 3.5, campusId: 4}),
      Student.create({id: 5, firstName: 'Joe', lastName: 'Smith', email: 'joeySmith@gmail.com', gpa: 3.5, campusId: 5}),
      Student.create({id: 6, firstName: 'Jake', lastName: 'Cook', email: 'jakeCook@yahoo.com', gpa: 3.5, campusId: 6}),
    ]);
    ...
    const campus5 = await Campus.create({
      id: 5, name: 'Campus 5',
      imageUrl: 'https://th.bing.com/th/id/R.f3215faee2adac283a87960d65550447?rik=6lbvse3S2GIOeg&riu=http%3a%2f%2fwww.mosaicaa.com%2fwp-content%2fuploads%2f2016%2f08%2f08052301_02.jpg&ehk=X6qpTyw3BGcIkSj3YYQd8l4vlbwrHgDEDYa4Nl2z%2fY0%3d&risl=&pid=ImgRaw&r=0',
      address: '1052 ST NW 44444 blah, EA',
      description: 'This is a great campus',
      student: [joe]
    });

    const campus6 = await Campus.create({
      id: 6, name: 'Campus 6',
      imageUrl: 'https://th.bing.com/th/id/R.f3215faee2adac283a87960d65550447?rik=6lbvse3S2GIOeg&riu=http%3a%2f%2fwww.mosaicaa.com%2fwp-content%2fuploads%2f2016%2f08%2f08052301_02.jpg&ehk=X6qpTyw3BGcIkSj3YYQd8l4vlbwrHgDEDYa4Nl2z%2fY0%3d&risl=&pid=ImgRaw&r=0',
      address: '1062 ST NW 55555 blah, FA',
      description: 'This is a wonderful campus',
      student: [jake]
    });
